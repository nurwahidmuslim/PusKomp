  ...
  <div class="container">
    <div class="card p-2 mt-5">
      <div class="position-absolute top-0 start-50 translate-middle">
        <img src="../../imgDB/profile-user.png" class="" alt="adminLogo" width="85px">
      </div>
      ...
      <form action="" method="post" class="row g-3 p-4 needs-validation" novalidate>
        ...
        <div class="col-12 d-flex justify-content-between">
          <a class="btn btn-cancel" href="../../index.html">Back</a>
          <button class="btn btn-signin" type="submit" name="signIn">Sign In</button>
        </div>
      </form>
    </div>
    <?php if(isset($error)) : ?>
