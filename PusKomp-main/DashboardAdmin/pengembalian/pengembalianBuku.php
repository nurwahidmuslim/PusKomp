...
$dataPeminjam = queryReadData("SELECT pengembalian.id_pengembalian, pengembalian.id_buku, buku.judul, buku.kategori, pengembalian.npm, member.nama, pengembalian.buku_kembali, pengembalian.keterlambatan, pengembalian.denda
FROM pengembalian
    ...
    <table class="table table-striped table-hover text-center">
     <thead class="text-center">
      <tr>
        ...
        <th class="bg-purple text-light">Nama Member</th>
        ...
        <th class="bg-purple text-light">Delete</th>
      </tr>
    </thead>
