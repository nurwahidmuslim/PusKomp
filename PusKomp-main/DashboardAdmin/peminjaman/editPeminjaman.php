...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Function to update the peminjaman record in the database
    function updatePeminjaman($id, $id_buku, $npm, $tgl_peminjaman, $tgl_pengembalian) {
        global $conn;
        $query = "UPDATE peminjaman SET id_buku = '$id_buku', npm = '$npm', tgl_peminjaman = '$tgl_peminjaman', tgl_pengembalian = '$tgl_pengembalian' WHERE id_peminjaman = $id";
    ...
    <div class="container mt-5 flex-grow-1 pt-5 mb-5">
        <div class="mt-5">
            ...
            <form method="post">
                ...
                <button type="submit" class="btn btn-success btn-update" name="pinjam">Update</button>
            </form>
        </div>
    </div>
