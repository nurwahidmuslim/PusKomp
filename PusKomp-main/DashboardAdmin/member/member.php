...
<head>
    ...
    .btn-purple:hover {
        background-color: #5a0cbb !important;
    }
    </style>
</head>
    ...
    <div class="container mt-5 flex-grow-1 pt-5 mb-5">
        ...
        <form action="" method="post" class="mt-5">
            <div class="input-group d-flex justify-content-end mb-3">
                ...
                <button class="btn btn-secondary" type="submit" name="search"><i class="fa-solid fa-magnifying-glass"></i></button>
            </div>
        </form>
        
        <div class="d-flex justify-content-end mb-3">
            <a href="tambahMember.php" class="btn btn-purple">Tambah Member</a>
        </div>
            ...
            <table class="table table-striped table-hover">
                <thead class="text-center">
                    <tr>
                        ...
                        <th class="bg-purple text-light">Jenis Kelamin</th>
                        <th class="bg-purple text-light">No Telepon</th>
                        <th class="bg-purple text-light">Actions</th>
                    </tr>
                </thead>
                <tbody class="text-center">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action">
                                <a href="editMember.php?id=<?= $item["npm"]; ?>" class="btn btn-warning"><i class="fa-solid fa-edit"></i></a>
