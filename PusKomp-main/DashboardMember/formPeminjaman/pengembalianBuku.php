...
$query = queryReadData("SELECT peminjaman.id_peminjaman, peminjaman.id_buku, buku.judul, peminjaman.npm, member.nama, peminjaman.tgl_peminjaman, peminjaman.tgl_pengembalian
FROM peminjaman
...
<html lang="en">
  ...
  <div class="d-flex flex-wrap gap-3">
    <div class="mb-3">
      <label for="exampleFormControlInput1" class="form-label">NPM Member</label>
      <input type="number" class="form-control" placeholder="NPM Member" name="npm" id="npm" value="<?= $item["npm"]; ?>" readonly>
    </div>
    <div class="mb-3">
      <label for="exampleFormControlInput1" class="form-label">Nama Member</label>
      <input type="text" class="form-control" placeholder="Nama Member" name="nama" id="nama" value=" <?= $item["nama"]; ?>" readonly>
    </div>
  </div>
