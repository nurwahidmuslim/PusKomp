    ...
    <div class="mt-3 p-3">
       ...
       <div class="mt-4 p-3">
        ...
        <div class="col bg-success p-5 rounded">
          <a class="text-center text-decoration-none fs-2 text-light" href="formPeminjaman/TransaksiPeminjaman.php">Peminjaman</a>
        </div>
        </div>
        <div class="row gap-2 mt-2">
        <div class="col bg-warning p-5 rounded">
          <a class="text-center text-decoration-none fs-2 text-light" href="formPeminjaman/TransaksiPengembalian.php">Pengembalian</a>
        </div>
        <div class="col bg-dark p-5 rounded">
          <a class="text-center text-decoration-none fs-2 text-light" href="formPeminjaman/TransaksiDenda.php">Denda</a>
        </div>
        </div>
      </div>
